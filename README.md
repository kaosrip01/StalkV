...
```sh
git clone https://github.com/kaosrip01/StalkV
...
Stalker auto install script v1.2.4 - RELEASE
  ...
  * fix bugs
  * fix deploy
  * Last Version Portal Ministra 5.5.0
  * Last Version Portal 5.2.0
  * fix nginx configs
  * fix vendor

Portal auto install script v5.4.0 - RELEASE
...
Portal auto install Portal Mini v 5.3.0 - RELEASE
  
  * Add dialog menu for choice Mini version installing
  * Checking OS Support
  * fix bugs
  * fix deploy
  * Last Version Portal Ministra 5.3.0
